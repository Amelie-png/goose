...
public class QuackstCompletedEvent : UnityEvent<Quackst> { } // QuackstCompletedEvent
...
public class QuackstEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (choice != -1) {
            ...
            m_QuackstGoalListProperty
                .GetArrayElementAtIndex(m_QuackstGoalListProperty.arraySize - 1)
